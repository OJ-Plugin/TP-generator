...
|------------------|--------------------------------------------|
| Windows          | [Download Windows v0.1.9 (*.exe)](https://github.com/OJ-Plugin/TP-generator/releases/download/v0.1.9/tp-generator_0.1.9_x64-setup.exe) |
| macOS            | [Download macOS v0.1.9 (*.dmg)](https://github.com/OJ-Plugin/TP-generator/releases/download/v0.1.9/tp-generator_0.1.9_aarch64.dmg) |
| Linux            | [Download Linux v0.1.9 (*.deb)](https://github.com/OJ-Plugin/TP-generator/releases/download/v0.1.9/tp-generator_0.1.9_amd64.deb) |
